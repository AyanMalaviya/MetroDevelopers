        ...
        <div className="flex flex-wrap gap-2 text-[0.7rem] items-center">
          ...
          <div className="flex gap-2 ml-auto">
            <a
              ...
              className={`flex items-center gap-2 px-3 py-2 text-[0.62rem] font-semibold rounded-lg transition-all ${
                theme === 'dark'
              ...
              <div className="space-y-4">
                ...
                <div className={`p-6 rounded-xl text-center ${theme === 'dark' ? 'bg-gray-700/50' : 'bg-gray-100'}`}>
                  ...
                  <div className="flex items-center justify-center gap-3">
                    {/* <div className="w-4 h-4 rounded-full shadow-lg" style={{ backgroundColor: getStatusColor(plotData[selectedPlot]?.status || 'available') }}></div> */}
