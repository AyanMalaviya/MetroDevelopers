          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
              ...
              <div className="lg:col-span-2 space-y-12">
                ...
                <div ref={overviewRef}>
                  <h2
                    className={`text-2xl sm:text-3xl font-bold text-white mb-6 flex items-center gap-3 transition-all duration-1000 ${
                  ...
                  <div
                    className={`bg-gray-900 rounded-xl p-6 sm:p-8 border border-gray-800 transition-all duration-1000 delay-150 ${
                      overviewInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
                    }`}
                  >
                ...
                <div ref={featuresRef}>
                  ...
                  <div className="grid grid-cols-2 gap-4 sm:gap-6">
                    {features.map((feature, index) => (
                      <div
                        key={index}
                        className={`bg-gray-900 p-4 sm:p-6 rounded-xl border border-gray-800 hover:border-brand-red/60 transition-all duration-1000 ${
                          featuresInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
                        }`}
