...
// Migrated from react-router-dom → next/link + next/navigation
// SEO metadata lives in src/app/not-found.jsx (metadata export)
...
const QUICK_LINKS = [
  ...
  { href: '/metro-industrial-park',              label: 'Industrial Park',      icon: Factory    },
  { href: '/industrial-sheds-in-changodar',      label: 'Sheds in Changodar',   icon: MapPin     },
  { href: '/industrial-shed-for-sale-changodar', label: 'Sheds for Sale',       icon: MapPin     },
  { href: '/industrial-shed-for-rent-changodar', label: 'Sheds for Rent',       icon: MapPin     },
  ...
  return (
    <div className={`relative overflow-hidden min-h-screen flex items-center justify-center pt-24 pb-20 px-4 ${
      ...
      >
        ...
        {/* SEO micro-copy — keyword context even on 404 */}
        <motion.p
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
