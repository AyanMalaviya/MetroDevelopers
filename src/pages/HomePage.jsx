...
import { Building2, Phone, Shield, ArrowRight, ChevronDown, Star, Award, Clock, Camera, Droplets, Route, Truck, Download, X } from 'lucide-react';
    ...
    <>
      ...
      <div className="min-h-screen bg-black">
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          {/* Scroll Indicator */}
          <div className="absolute bottom-16 sm:bottom-20 left-1/2 -translate-x-1/2 animate-bounce z-20">
